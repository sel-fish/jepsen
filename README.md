...
This project forks from https://github.com/aphyr/jepsen
I clear the git info just because the .git directory is too big for me to checkout
even after I run 
```
git reflog expire --all --expire=now
git gc --prune=now --aggressive
```
which I get from [here](http://stackoverflow.com/questions/2116778/reduce-git-repository-size).
